...
Continue to: [Set up Apache Airflow](02-apache-airflow-setup.md)

## Build

Apply what you learned: [Batch file ETL before orchestration](../../projects/intermediate/batch-file-etl/)
