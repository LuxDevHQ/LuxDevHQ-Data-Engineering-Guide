...
Continue to: [PostgreSQL setup and SQL introduction](../03-sql-and-databases/postgresql-setup-and-sql-introduction.md)

## Practice

Try: [Linux server administration](../../exercises/assignments/linux-server-administration.md)

## Build

Apply what you learned: [Aiven PostgreSQL](../../projects/beginner/aiven-postgresql/)
