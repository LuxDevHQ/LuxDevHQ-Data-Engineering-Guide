...
Continue to: [Advanced SQL](advanced-sql.md)

## Practice

Try: [SQL practice questions](../../exercises/sql/sql-practice-questions.md)

## Build

Apply what you learned: [Simple CSV ETL](../../projects/intermediate/simple-csv-etl/)
