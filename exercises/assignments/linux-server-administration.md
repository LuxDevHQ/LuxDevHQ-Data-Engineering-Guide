> **Safety notice:** Historical public credentials were removed during the repository cleanup. Use only a temporary host and credentials supplied privately by your instructor.
...
- **Host:** <instructor-provided-host>
- **Username:** `<instructor-provided-user>`
...
```bash
ssh <instructor-provided-user>@<instructor-provided-host> -p 22
```
#### **Important Notes**
